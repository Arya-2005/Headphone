...
<body>
    ...
    <header class="header" id="header">
        <nav class="nav container">
            <a href="#" class="nav__logo">
                <img src="https://github.com/Arpayan/image/blob/main/logo.png?raw=true" alt="">
            </a>
    ...
    <main class="main">
        ...
        <section class="home section" id="home">
            <div class="home__container container grid">
                <div>
                    <img src="https://github.com/Arpayan/image/blob/main/home.png?raw=true" alt="" class="home__img">
                </div>
        ...
        <section class="sponsor section">
            <div class="sponsor__container container grid">
                <img src="https://github.com/Arpayan/image/blob/main/sponsor1.png?raw=true" alt="" class="sponsor__img">
                <img src="https://github.com/Arpayan/image/blob/main/sponsor2.png?raw=true" alt="" class="sponsor__img">
                <img src="https://github.com/Arpayan/image/blob/main/sponsor3.png?raw=true" alt="" class="sponsor__img">
                <img src="https://github.com/Arpayan/image/blob/main/sponsor4.png?raw=true" alt="" class="sponsor__img">
            </div>
        </section>
        ...
        <section class="specs section grid" id="specs">
            ...
            <div class="specs__container container grid">
                ...
                <div>
                    <img src="https://github.com/Arpayan/image/blob/main/specs.png?raw=true" alt="" class="specs__img">
                </div>
            </div>
        </section>
        ...
        <section class="case section grid" id="case">
            ...
            <div class="case__container container grid">
                <div>
                    <img src="https://github.com/Arpayan/image/blob/main/case.png?raw=true" alt="" class="case__img">
                </div>
        ...
        <section class="discount section">
            <div class="discount__container container grid">
                ...
                <img src="https://github.com/Arpayan/image/blob/main/discount.png?raw=true" alt=""
                    class="discount__img">
            </div>
        </section>
            ...
            <div class="products__container container grid">
                <article class="products__card">
                    <div class="products__content">
                        <img src="https://github.com/Arpayan/image/blob/main/product1.png?raw=true" alt=""
                            class="products__img">
                ...
                <article class="products__card">
                    <div class="products__content">
                        <img src="https://github.com/Arpayan/image/blob/main/product2.png?raw=true" alt=""
                            class="products__img">
                ...
                <article class="products__card">
                    <div class="products__content">
                        <img src="https://github.com/Arpayan/image/blob/main/product3.png?raw=true" alt=""
                            class="products__img">
                ...
                <article class="products__card">
                    <div class="products__content">
                        <img src="https://github.com/Arpayan/image/blob/main/product4.png?raw=true" alt=""
                            class="products__img">
                ...
                <article class="products__card">
                    <div class="products__content">
                        <img src="https://github.com/Arpayan/image/blob/main/product5.png?raw=true" alt=""
                            class="products__img">
    ...
    <footer class="footer section">
        ...
        <p class="footer__copy">
            <a href="https://www.youtube.com/c/Bedimcode/" target="_blank" class="footer__copy-link">&#169; Bedimcode.
